...
<?php
if (!empty($front_page_options['six_sides_video']) && !empty($front_page_options['six_sides_video_ratio'])) {
?>
  ...
  <div class="grid-row">
    <div class="grid-item item-s-8 offset-s-2 item-m-6 offset-m-3 item-l-4 offset-l-4 text-align-center">
      <div class="video-wrapper">
        <video class="module-video wrapped-video" autoplay loop preload width="100%" muted playsinline data-ratio="<?php echo $front_page_options['six_sides_video_ratio']; ?>">
